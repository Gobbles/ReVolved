...
void ParticleManager::MakeShotFlash(sf::Vector2f loc, sf::Vector2f traj)
{
    ...
    //       Commands::GetRandomVector2(-5.f, 5.f, -5.f, 5.f),
    //        traj / 5f, (20f - (float)i) * 0.06f));
    //}
    //for (int i = 0; i < 4; i++)
    //    AddParticle(new Smoke(loc, Rand.GetRandomVector2(-30f, 30f, -100f, 0f),
    //        0f, 0f, 0f, 0.25f, Rand.GetRandomFloat(0.25f, 1.0f),
...
void ParticleManager::MakeBulletBlood(sf::Vector2f loc, sf::Vector2f traj)
{
	/*for (int t = 0; t < 32; t++)
	{
        ...
        loc,
        traj *
        -1.f * Commands::GetRandomFloat(0.01f, 0.1f) +
        Commands::GetRandomVector2(-50.f, 50.f, -50.f, 50.f),
        1.f, 0.f, 0.f, 1.f,
        Commands::GetRandomFloat(0.1f, 0.3f),
        Commands::GetRandomInt(0, 4)));
	}*/
}
